class GameScene extends Phaser.Scene {
    ...
    preload(){
        this.load.image('bg', "assets/sprites/bg-ca.png");
    ...
    createText(){
        this.levelText = this.add.text(37.795, config.height/2 - 75, '', {
            font: '32px pinkchicken',
            fill: '#fff',
        }).setOrigin(0, 0.5);
        this.scoreText = this.add.text(37.795, config.height/2, '', {
            font: '32px pinkchicken',
            fill: '#fff',
        }).setOrigin(0, 0.5);
        this.timeoutText = this.add.text(37.795, config.height/2 + 75, '', {
            font: '32px pinkchicken',
            fill: '#fff',
        }).setOrigin(0, 0.5);
        this.coinsText = this.add.text(37.795, config.height/2 - '', '', {
            font: '32px pinkchicken',
            fill: '#fff',
        }).setOrigin(0, 0.5);
    }
